...
LABEL maintainer="inhere <zhl@1bug.com>" version="2.0"
...
COPY ./cacert.pem /d/cacert.pem
COPY ./oniguruma-6.9.4.tar.gz /d/oniguruma-6.9.4.tar.gz
COPY ./libzip-1.2.0.tar.gz /d/libzip-1.2.0.tar.gz
...
# Install GD
    ...
    && docker-php-ext-configure gd --with-freetype=/var/www/ --with-jpeg=/var/www/ --with-webp=/var/www/ \
    && docker-php-ext-install -j$(nproc) gd \
# Clean apt cache
    && rm -rf /var/lib/apt/lists/*

RUN echo openssl.cafile="/d/cacert.pem" >> /usr/local/etc/php/conf.d/openssl1.ini 
# Install composer
